...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fighter.fm_url'
        db.add_column(u'fighter_fighter', 'fm_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Fighter.mma_url'
        db.add_column(u'fighter_fighter', 'mma_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fighter.fm_url'
        db.delete_column(u'fighter_fighter', 'fm_url')

        # Deleting field 'Fighter.mma_url'
        db.delete_column(u'fighter_fighter', 'mma_url')
