...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fighter.last_opponent'
        db.add_column(u'fighter_fighter', 'last_opponent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fighter.Fighter'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fighter.last_opponent'
        db.delete_column(u'fighter_fighter', 'last_opponent_id')
